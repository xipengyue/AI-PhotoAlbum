    ...
    <div class="flex items-end gap-3 max-w-4xl mx-auto">
      ...
      <div class="flex-1 relative">
        <textarea
          ...
          rows="1"
          class="w-full resize-none rounded-xl border border-gray-200 px-4 py-2.5 pr-10 text-sm
      ...
      <button
        v-if="isStreaming"
        class="shrink-0 w-10 h-10 rounded-full bg-red-50 hover:bg-red-100 text-red-500
      ...
      <button
        ...
        class="shrink-0 w-10 h-10 rounded-full flex items-center justify-center transition-colors
               bg-blue-500 hover:bg-blue-600 disabled:bg-gray-200 disabled:cursor-not-allowed"
        title="发送"
        aria-label="发送"
        @click="send"
      >
